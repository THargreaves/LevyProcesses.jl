...
- `TruncatedLevyProcess(p; l, u)` retains `l < abs(x) <= u`. Sampling requires finite retained intensity and returns jump times in `[0, dt]` and their sizes, without adding drift.
